    ...
    public class ReportNode : AbstractNode
    {
        ...
        private async Task Create()
        {
            try
            {
                ...
                HttpResponseMessage response = await Client.PostAsync($"{ServerPath}/reports?employeeId={EmployeeNode.CurrentEmployee.Id}", null);
        ...
        private async Task Get()
        {
            try
            {
                HttpResponseMessage response = await Client.GetAsync($"{ServerPath}/reports");
        ...
        private async Task CreateSprintReport()
        {
            try
            {
                HttpResponseMessage response = await Client
                    .PostAsync(
                        $"{ServerPath}/reports/sprint?employeeId={EmployeeNode.CurrentEmployee.Id}",
                        null);
